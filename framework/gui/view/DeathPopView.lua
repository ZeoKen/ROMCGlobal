...
function DeathPopView:initView()
  ...
  if self.isPvpMap or self.mapMng:IsRaidPuzzle() or self.mapMng:IsPVEMode_ComodoRaid() or self.mapMng:IsPVEMode_MultiBossRaid() or self.mapMng:IsPVEMode_Element() or self.mapMng:IsPVEMode_StarArk() or self.mapMng:IsPVPMode_EndlessBattleField() or self.mapMng:IsPVEMode_AbyssDragon() or self.mapMng:IsInSnowRealmHouseRaid() then
...
function DeathPopView:addEventListener()
  ...
  self:AddButtonEvent("ReliveInRelivePointBtn", function(obj)
    if self.mapMng:IsPVEMode_ComodoRaid() or self.mapMng:IsPVEMode_MultiBossRaid() or self.mapMng:IsPVEMode_Element() or self.mapMng:IsPVEMode_StarArk() or self.mapMng:IsPVPMode_EndlessBattleField() or self.mapMng:IsInSnowRealmHouseRaid() then
