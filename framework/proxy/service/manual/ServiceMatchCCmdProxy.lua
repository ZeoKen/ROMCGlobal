...
function ServiceMatchCCmdProxy:CallJoinRoomCCmd(type, roomid, name, isquick, teamid, teammember, ret, guildid, users, matcher, charid, zoneid, serverid, teamexptype, onlymyserver, entranceid, need_robot_npc, need_heal_profession, abyss_option, snow_option)
  ...
  ServiceMatchCCmdProxy.super.CallJoinRoomCCmd(self, type, roomid, name, isquick, teamid, teammember, ret, guildid, users, matcher, charid, zoneid, serverid, teamexptype, onlymyserver, entranceid, need_robot_npc, need_heal_profession, abyss_option, snow_option)
end
