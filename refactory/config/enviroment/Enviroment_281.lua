local Enviroment_281 = {
  ...
  fog = {
    ...
    heightFogStart = -160,
    heightFogEnd = 500,
    scatteringDensity = 0.730000019073486,
    scatteringFalloff = 4,
    scatteringExponent = 1.89999997615814,
  ...
  volumes = {
    ...
    [8] = {
      ...
      skybox = {
        texPath = "Enviroment/CustomSkyboxes/sky_sc_syzh_03",
        tint = {
          1,
          1,
          1,
