...
function FunctionLogin:ChangeServerType(serverType)
  ...
  GameFacade.Instance:registerProxy(SnowRealmProxy.new())
  ...
  ActivityChallengeProxy.new()
  autoImport("LoopActIntegrationProxy")
  LoopActIntegrationProxy.new()
  ...
  AccumulativeShopProxy.new()
  autoImport("RecallInfoProxy")
  RecallInfoProxy.new()
  autoImport("RecallSignProxy")
  RecallSignProxy.new()
  autoImport("RecallWeeklyTaskProxy")
  RecallWeeklyTaskProxy.new()
  autoImport("RecallFundProxy")
  RecallFundProxy.new()
  autoImport("RecallShopProxy")
  RecallShopProxy.new()
  autoImport("RecallCatchUpProxy")
  RecallCatchUpProxy.new()
