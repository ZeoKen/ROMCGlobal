...
UDEnum = {
  ...
  NOKR_DIAMOND = "NOKR_DIAMOND",
  NOKR_FREE_DIAMOND = "NOKR_FREE_DIAMOND",
  ...
  DAM_REDUCE_TYPE = "DAM_REDUCE_TYPE",
  RIDING_HANDCART_OWNER = "RIDING_HANDCART_OWNER",
  OWN_HANDCART = "OWN_HANDCART",
  RIDING_HANDCART_SEAT = "RIDING_HANDCART_SEAT",
  ROBOT_USER = "ROBOT_USER",
  SNOW_ROOMID = "SNOW_ROOMID",
  ROBOT_MASTER = "ROBOT_MASTER",
  SOUL_PUPPET = "SOUL_PUPPET",
  CARRY_UP_CHARID = "CARRY_UP_CHARID",
  CARRY_DOWN_CHARID = "CARRY_DOWN_CHARID"
}
