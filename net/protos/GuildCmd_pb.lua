...
GUILDPARAM_GUILDPARAM_GVG_CITYINFO_OPEN_ENUM = protobuf.EnumValueDescriptor()
...
EGUILDMEMBERDATA_EGUILDMEMBERDATA_HEAD_FASHION_ENUM = protobuf.EnumValueDescriptor()
EGUILDMEMBERDATA_EGUILDMEMBERDATA_SNOW_ROOMID_ENUM = protobuf.EnumValueDescriptor()
...
EGVGCITYFRIENDSTATE = protobuf.EnumDescriptor()
EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_MIN_ENUM = protobuf.EnumValueDescriptor()
EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_TEAM_LEADER_ENUM = protobuf.EnumValueDescriptor()
EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_GROUP_LEADER_ENUM = protobuf.EnumValueDescriptor()
EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_GUILD_CHAIRMAN_ENUM = protobuf.EnumValueDescriptor()
EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_MAX_ENUM = protobuf.EnumValueDescriptor()
ECITYINFOQUERYTYPE = protobuf.EnumDescriptor()
ECITYINFOQUERYTYPE_ECITYINFOQUERYTYPE_NORMAL_ENUM = protobuf.EnumValueDescriptor()
ECITYINFOQUERYTYPE_ECITYINFOQUERYTYPE_UI_OPEN_ENUM = protobuf.EnumValueDescriptor()
ECITYINFOQUERYTYPE_ECITYINFOQUERYTYPE_UI_CLOSE_ENUM = protobuf.EnumValueDescriptor()
...
EGUILDDATEBATTLETYPE = protobuf.EnumDescriptor()
EGUILDDATEBATTLETYPE_EGUILDDATEBATTLETYPE_MIN_ENUM = protobuf.EnumValueDescriptor()
EGUILDDATEBATTLETYPE_EGUILDDATEBATTLETYPE_BASE_ENUM = protobuf.EnumValueDescriptor()
EGUILDDATEBATTLETYPE_EGUILDDATEBATTLETYPE_DEATH_ENUM = protobuf.EnumValueDescriptor()
EGUILDDATEBATTLETYPE_EGUILDDATEBATTLETYPE_BLOOD_ENUM = protobuf.EnumValueDescriptor()
...
GUILDMEMBER_SNOWROOMID_FIELD = protobuf.FieldDescriptor()
...
GUILDMEMBER_SERVERID_FIELD = protobuf.FieldDescriptor()
GUILDMEMBER_REDTIPS_FIELD = protobuf.FieldDescriptor()
GUILDMEMBER_HEAD_FASHION_FIELD = protobuf.FieldDescriptor()
...
GUILDAPPLY_HEAD_FASHION_FIELD = protobuf.FieldDescriptor()
...
GUILDARTIFACTITEM_OVERTIME_FIELD = protobuf.FieldDescriptor()
...
GUILDARTIFACTCONSUMABLECD = protobuf.Descriptor()
GUILDARTIFACTCONSUMABLECD_ITEMID_FIELD = protobuf.FieldDescriptor()
GUILDARTIFACTCONSUMABLECD_CD_FIELD = protobuf.FieldDescriptor()
...
GUILDARTIFACT_CONSUMABLE_CDS_FIELD = protobuf.FieldDescriptor()
...
GUILDSUMMARYDATA_SERVERID_FIELD = protobuf.FieldDescriptor()
...
CITYSHOWINFO_ATTACKER_COUNT_FIELD = protobuf.FieldDescriptor()
CITYSHOWINFO_MY_GUILD_MEMBER_COUNT_FIELD = protobuf.FieldDescriptor()
CITYSHOWINFO_FRIEND_STATE_FIELD = protobuf.FieldDescriptor()
CITYSHOWINFO_CALM_END_TIME_FIELD = protobuf.FieldDescriptor()
USERFRIENDINFO = protobuf.Descriptor()
USERFRIENDINFO_TEAMID_FIELD = protobuf.FieldDescriptor()
USERFRIENDINFO_IS_TEAM_LEADER_FIELD = protobuf.FieldDescriptor()
USERFRIENDINFO_GROUPID_FIELD = protobuf.FieldDescriptor()
USERFRIENDINFO_IS_GROUP_LEADER_FIELD = protobuf.FieldDescriptor()
USERFRIENDINFO_GUILDID_FIELD = protobuf.FieldDescriptor()
USERFRIENDINFO_IS_GUILD_CHAIRMAN_FIELD = protobuf.FieldDescriptor()
...
QUERYGCITYSHOWINFOGUILDCMD_QUERY_TYPE_FIELD = protobuf.FieldDescriptor()
QUERYGCITYSHOWINFOGUILDCMD_FRIEND_INFO_FIELD = protobuf.FieldDescriptor()
...
GVGOPENFIREGUILDCMD_TIMEZONEID_FIELD = protobuf.FieldDescriptor()
...
SUPERGVGGUILDDATA_SERVERID_FIELD = protobuf.FieldDescriptor()
...
GUILDSHOWINFO_SERVERID_FIELD = protobuf.FieldDescriptor()
...
DATEBATTLEEXTRAINFO = protobuf.Descriptor()
DATEBATTLEEXTRAINFO_TYPE_FIELD = protobuf.FieldDescriptor()
DATEBATTLEEXTRAINFO_TARGET_NUM_FIELD = protobuf.FieldDescriptor()
DATEBATTLEEXTRAINFO_CARDIDS_FIELD = protobuf.FieldDescriptor()
...
DATEBATTLEDATA_INFO_FIELD = protobuf.FieldDescriptor()
...
DATEBATTLEINVITEGUILDCMD_INFO_FIELD = protobuf.FieldDescriptor()
...
DATEBATTLEREPORTGUILDCMD_DEATH_COUNT_FIELD = protobuf.FieldDescriptor()
DATEBATTLEREPORTGUILDCMD_ATK_KILL_COUNT_FIELD = protobuf.FieldDescriptor()
DATEBATTLEREPORTGUILDCMD_DEF_KILL_COUNT_FIELD = protobuf.FieldDescriptor()
...
GUILDPARAM_GUILDPARAM_GVG_CITYINFO_OPEN_ENUM.name = "GUILDPARAM_GVG_CITYINFO_OPEN"
GUILDPARAM_GUILDPARAM_GVG_CITYINFO_OPEN_ENUM.index = 109
GUILDPARAM_GUILDPARAM_GVG_CITYINFO_OPEN_ENUM.number = 117
...
GUILDPARAM.values = {
  ...
  GUILDPARAM_GUILDPARAM_GVG_CITYINFO_OPEN_ENUM
}
...
EGUILDMEMBERDATA_EGUILDMEMBERDATA_HEAD_FASHION_ENUM.name = "EGUILDMEMBERDATA_HEAD_FASHION"
EGUILDMEMBERDATA_EGUILDMEMBERDATA_HEAD_FASHION_ENUM.index = 38
EGUILDMEMBERDATA_EGUILDMEMBERDATA_HEAD_FASHION_ENUM.number = 39
EGUILDMEMBERDATA_EGUILDMEMBERDATA_SNOW_ROOMID_ENUM.name = "EGUILDMEMBERDATA_SNOW_ROOMID"
EGUILDMEMBERDATA_EGUILDMEMBERDATA_SNOW_ROOMID_ENUM.index = 39
EGUILDMEMBERDATA_EGUILDMEMBERDATA_SNOW_ROOMID_ENUM.number = 40
EGUILDMEMBERDATA_EGUILDMEMBERDATA_MAX_ENUM.name = "EGUILDMEMBERDATA_MAX"
EGUILDMEMBERDATA_EGUILDMEMBERDATA_MAX_ENUM.index = 40
EGUILDMEMBERDATA_EGUILDMEMBERDATA_MAX_ENUM.number = 41
...
EGUILDMEMBERDATA.values = {
  ...
  EGUILDMEMBERDATA_EGUILDMEMBERDATA_HEAD_FASHION_ENUM,
  EGUILDMEMBERDATA_EGUILDMEMBERDATA_SNOW_ROOMID_ENUM,
...
EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_MIN_ENUM.name = "EGVG_CITY_FRIEND_STATE_MIN"
EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_MIN_ENUM.index = 0
EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_MIN_ENUM.number = 0
EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_TEAM_LEADER_ENUM.name = "EGVG_CITY_FRIEND_STATE_TEAM_LEADER"
EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_TEAM_LEADER_ENUM.index = 1
EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_TEAM_LEADER_ENUM.number = 1
EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_GROUP_LEADER_ENUM.name = "EGVG_CITY_FRIEND_STATE_GROUP_LEADER"
EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_GROUP_LEADER_ENUM.index = 2
EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_GROUP_LEADER_ENUM.number = 2
EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_GUILD_CHAIRMAN_ENUM.name = "EGVG_CITY_FRIEND_STATE_GUILD_CHAIRMAN"
EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_GUILD_CHAIRMAN_ENUM.index = 3
EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_GUILD_CHAIRMAN_ENUM.number = 3
EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_MAX_ENUM.name = "EGVG_CITY_FRIEND_STATE_MAX"
EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_MAX_ENUM.index = 4
EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_MAX_ENUM.number = 4
EGVGCITYFRIENDSTATE.name = "EGvgCityFriendState"
EGVGCITYFRIENDSTATE.full_name = ".Cmd.EGvgCityFriendState"
EGVGCITYFRIENDSTATE.values = {
  EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_MIN_ENUM,
  EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_TEAM_LEADER_ENUM,
  EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_GROUP_LEADER_ENUM,
  EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_GUILD_CHAIRMAN_ENUM,
  EGVGCITYFRIENDSTATE_EGVG_CITY_FRIEND_STATE_MAX_ENUM
}
ECITYINFOQUERYTYPE_ECITYINFOQUERYTYPE_NORMAL_ENUM.name = "ECITYINFOQUERYTYPE_NORMAL"
ECITYINFOQUERYTYPE_ECITYINFOQUERYTYPE_NORMAL_ENUM.index = 0
ECITYINFOQUERYTYPE_ECITYINFOQUERYTYPE_NORMAL_ENUM.number = 0
ECITYINFOQUERYTYPE_ECITYINFOQUERYTYPE_UI_OPEN_ENUM.name = "ECITYINFOQUERYTYPE_UI_OPEN"
ECITYINFOQUERYTYPE_ECITYINFOQUERYTYPE_UI_OPEN_ENUM.index = 1
ECITYINFOQUERYTYPE_ECITYINFOQUERYTYPE_UI_OPEN_ENUM.number = 1
ECITYINFOQUERYTYPE_ECITYINFOQUERYTYPE_UI_CLOSE_ENUM.name = "ECITYINFOQUERYTYPE_UI_CLOSE"
ECITYINFOQUERYTYPE_ECITYINFOQUERYTYPE_UI_CLOSE_ENUM.index = 2
ECITYINFOQUERYTYPE_ECITYINFOQUERYTYPE_UI_CLOSE_ENUM.number = 2
ECITYINFOQUERYTYPE.name = "ECityInfoQueryType"
ECITYINFOQUERYTYPE.full_name = ".Cmd.ECityInfoQueryType"
ECITYINFOQUERYTYPE.values = {
  ECITYINFOQUERYTYPE_ECITYINFOQUERYTYPE_NORMAL_ENUM,
  ECITYINFOQUERYTYPE_ECITYINFOQUERYTYPE_UI_OPEN_ENUM,
  ECITYINFOQUERYTYPE_ECITYINFOQUERYTYPE_UI_CLOSE_ENUM
}
...
EGUILDDATEBATTLETYPE_EGUILDDATEBATTLETYPE_MIN_ENUM.name = "EGUILDDATEBATTLETYPE_MIN"
EGUILDDATEBATTLETYPE_EGUILDDATEBATTLETYPE_MIN_ENUM.index = 0
EGUILDDATEBATTLETYPE_EGUILDDATEBATTLETYPE_MIN_ENUM.number = 0
EGUILDDATEBATTLETYPE_EGUILDDATEBATTLETYPE_BASE_ENUM.name = "EGUILDDATEBATTLETYPE_BASE"
EGUILDDATEBATTLETYPE_EGUILDDATEBATTLETYPE_BASE_ENUM.index = 1
EGUILDDATEBATTLETYPE_EGUILDDATEBATTLETYPE_BASE_ENUM.number = 1
EGUILDDATEBATTLETYPE_EGUILDDATEBATTLETYPE_DEATH_ENUM.name = "EGUILDDATEBATTLETYPE_DEATH"
EGUILDDATEBATTLETYPE_EGUILDDATEBATTLETYPE_DEATH_ENUM.index = 2
EGUILDDATEBATTLETYPE_EGUILDDATEBATTLETYPE_DEATH_ENUM.number = 2
EGUILDDATEBATTLETYPE_EGUILDDATEBATTLETYPE_BLOOD_ENUM.name = "EGUILDDATEBATTLETYPE_BLOOD"
EGUILDDATEBATTLETYPE_EGUILDDATEBATTLETYPE_BLOOD_ENUM.index = 3
EGUILDDATEBATTLETYPE_EGUILDDATEBATTLETYPE_BLOOD_ENUM.number = 3
EGUILDDATEBATTLETYPE.name = "EGuildDateBattleType"
EGUILDDATEBATTLETYPE.full_name = ".Cmd.EGuildDateBattleType"
EGUILDDATEBATTLETYPE.values = {
  EGUILDDATEBATTLETYPE_EGUILDDATEBATTLETYPE_MIN_ENUM,
  EGUILDDATEBATTLETYPE_EGUILDDATEBATTLETYPE_BASE_ENUM,
  EGUILDDATEBATTLETYPE_EGUILDDATEBATTLETYPE_DEATH_ENUM,
  EGUILDDATEBATTLETYPE_EGUILDDATEBATTLETYPE_BLOOD_ENUM
}
...
GUILDMEMBER_SNOWROOMID_FIELD.name = "snowroomid"
GUILDMEMBER_SNOWROOMID_FIELD.full_name = ".Cmd.GuildMember.snowroomid"
GUILDMEMBER_SNOWROOMID_FIELD.number = 57
GUILDMEMBER_SNOWROOMID_FIELD.index = 21
GUILDMEMBER_SNOWROOMID_FIELD.label = 1
GUILDMEMBER_SNOWROOMID_FIELD.has_default_value = false
GUILDMEMBER_SNOWROOMID_FIELD.default_value = 0
GUILDMEMBER_SNOWROOMID_FIELD.type = 13
GUILDMEMBER_SNOWROOMID_FIELD.cpp_type = 3
...
GUILDMEMBER_GENDER_FIELD.index = 22
...
GUILDMEMBER_PROFESSION_FIELD.index = 23
...
GUILDMEMBER_JOB_FIELD.index = 24
...
GUILDMEMBER_NAME_FIELD.index = 25
...
GUILDMEMBER_VAR_FIELD.index = 26
...
GUILDMEMBER_PRAY_FIELD.index = 27
...
GUILDMEMBER_DONATE_FIELD.index = 28
...
GUILDMEMBER_LEVELUPEFFECT_FIELD.index = 29
...
GUILDMEMBER_EXCHANGEZONE_FIELD.index = 30
...
GUILDMEMBER__ACCID_FIELD.index = 31
...
GUILDMEMBER_ACCID_FIELD.index = 32
...
GUILDMEMBER_MERCENARY_GUILD_ID_FIELD.index = 33
...
GUILDMEMBER_BUILDING_FIELD.index = 34
...
GUILDMEMBER_CHALLENGE_FIELD.index = 35
...
GUILDMEMBER_LASTEXITTIME_FIELD.index = 36
...
GUILDMEMBER_REDTIP_FIELD.index = 37
...
GUILDMEMBER_BUILDINGEFFECT_FIELD.index = 38
...
GUILDMEMBER_REALTIMEVOICE_FIELD.index = 39
...
GUILDMEMBER_WEEKBCOIN_FIELD.index = 40
...
GUILDMEMBER_TOTALCOIN_FIELD.index = 41
...
GUILDMEMBER_TEAMNAME_FIELD.index = 42
...
GUILDMEMBER_PORTRAIT_FRAME_FIELD.index = 43
...
GUILDMEMBER_BIFROST_SCORE_FIELD.index = 44
...
GUILDMEMBER_ONLINETIME_FIELD.index = 45
...
GUILDMEMBER_USERRETURNENDTIME_FIELD.index = 46
...
GUILDMEMBER_GUIDE_QUEST_LV_FIELD.index = 47
...
GUILDMEMBER_ASSEMBLYENDTIME_FIELD.index = 48
...
GUILDMEMBER_ASSEMBLYSTATUS_FIELD.index = 49
...
GUILDMEMBER_ASSEMBLYINCURGUILD_FIELD.index = 50
...
GUILDMEMBER_REFRESHED_MENU_LV_FIELD.index = 51
...
GUILDMEMBER_MERCENARY_NAME_INDEX_FIELD.index = 52
...
GUILDMEMBER_SERVERID_FIELD.name = "serverid"
GUILDMEMBER_SERVERID_FIELD.full_name = ".Cmd.GuildMember.serverid"
GUILDMEMBER_SERVERID_FIELD.number = 54
GUILDMEMBER_SERVERID_FIELD.index = 53
GUILDMEMBER_SERVERID_FIELD.label = 1
GUILDMEMBER_SERVERID_FIELD.has_default_value = false
GUILDMEMBER_SERVERID_FIELD.default_value = 0
GUILDMEMBER_SERVERID_FIELD.type = 13
GUILDMEMBER_SERVERID_FIELD.cpp_type = 3
...
GUILDMEMBER_REDTIPS_FIELD.index = 54
...
GUILDMEMBER_HEAD_FASHION_FIELD.name = "head_fashion"
GUILDMEMBER_HEAD_FASHION_FIELD.full_name = ".Cmd.GuildMember.head_fashion"
GUILDMEMBER_HEAD_FASHION_FIELD.number = 56
GUILDMEMBER_HEAD_FASHION_FIELD.index = 55
GUILDMEMBER_HEAD_FASHION_FIELD.label = 1
GUILDMEMBER_HEAD_FASHION_FIELD.has_default_value = false
GUILDMEMBER_HEAD_FASHION_FIELD.default_value = ""
GUILDMEMBER_HEAD_FASHION_FIELD.type = 9
GUILDMEMBER_HEAD_FASHION_FIELD.cpp_type = 9
...
GUILDMEMBER.fields = {
  ...
  GUILDMEMBER_SERVERID_FIELD,
  GUILDMEMBER_REDTIPS_FIELD,
  GUILDMEMBER_HEAD_FASHION_FIELD
}
...
GUILDAPPLY_HEAD_FASHION_FIELD.name = "head_fashion"
GUILDAPPLY_HEAD_FASHION_FIELD.full_name = ".Cmd.GuildApply.head_fashion"
GUILDAPPLY_HEAD_FASHION_FIELD.number = 20
GUILDAPPLY_HEAD_FASHION_FIELD.index = 18
GUILDAPPLY_HEAD_FASHION_FIELD.label = 1
GUILDAPPLY_HEAD_FASHION_FIELD.has_default_value = false
GUILDAPPLY_HEAD_FASHION_FIELD.default_value = ""
GUILDAPPLY_HEAD_FASHION_FIELD.type = 9
GUILDAPPLY_HEAD_FASHION_FIELD.cpp_type = 9
...
GUILDARTIFACTITEM_OVERTIME_FIELD.name = "overtime"
GUILDARTIFACTITEM_OVERTIME_FIELD.full_name = ".Cmd.GuildArtifactItem.overtime"
GUILDARTIFACTITEM_OVERTIME_FIELD.number = 7
GUILDARTIFACTITEM_OVERTIME_FIELD.index = 5
GUILDARTIFACTITEM_OVERTIME_FIELD.label = 1
GUILDARTIFACTITEM_OVERTIME_FIELD.has_default_value = true
GUILDARTIFACTITEM_OVERTIME_FIELD.default_value = 0
GUILDARTIFACTITEM_OVERTIME_FIELD.type = 13
GUILDARTIFACTITEM_OVERTIME_FIELD.cpp_type = 3
...
GUILDARTIFACTITEM.fields = {
  ...
  GUILDARTIFACTITEM_OVERTIME_FIELD
}
...
GUILDARTIFACTCONSUMABLECD_ITEMID_FIELD.name = "itemid"
GUILDARTIFACTCONSUMABLECD_ITEMID_FIELD.full_name = ".Cmd.GuildArtifactConsumableCD.itemid"
GUILDARTIFACTCONSUMABLECD_ITEMID_FIELD.number = 1
GUILDARTIFACTCONSUMABLECD_ITEMID_FIELD.index = 0
GUILDARTIFACTCONSUMABLECD_ITEMID_FIELD.label = 1
GUILDARTIFACTCONSUMABLECD_ITEMID_FIELD.has_default_value = true
GUILDARTIFACTCONSUMABLECD_ITEMID_FIELD.default_value = 0
GUILDARTIFACTCONSUMABLECD_ITEMID_FIELD.type = 13
GUILDARTIFACTCONSUMABLECD_ITEMID_FIELD.cpp_type = 3
GUILDARTIFACTCONSUMABLECD_CD_FIELD.name = "cd"
GUILDARTIFACTCONSUMABLECD_CD_FIELD.full_name = ".Cmd.GuildArtifactConsumableCD.cd"
GUILDARTIFACTCONSUMABLECD_CD_FIELD.number = 2
GUILDARTIFACTCONSUMABLECD_CD_FIELD.index = 1
GUILDARTIFACTCONSUMABLECD_CD_FIELD.label = 1
GUILDARTIFACTCONSUMABLECD_CD_FIELD.has_default_value = true
GUILDARTIFACTCONSUMABLECD_CD_FIELD.default_value = 0
GUILDARTIFACTCONSUMABLECD_CD_FIELD.type = 4
GUILDARTIFACTCONSUMABLECD_CD_FIELD.cpp_type = 4
GUILDARTIFACTCONSUMABLECD.name = "GuildArtifactConsumableCD"
GUILDARTIFACTCONSUMABLECD.full_name = ".Cmd.GuildArtifactConsumableCD"
GUILDARTIFACTCONSUMABLECD.nested_types = {}
GUILDARTIFACTCONSUMABLECD.enum_types = {}
GUILDARTIFACTCONSUMABLECD.fields = {
  GUILDARTIFACTCONSUMABLECD_ITEMID_FIELD,
  GUILDARTIFACTCONSUMABLECD_CD_FIELD
}
GUILDARTIFACTCONSUMABLECD.is_extendable = false
GUILDARTIFACTCONSUMABLECD.extensions = {}
...
GUILDARTIFACT_CONSUMABLE_CDS_FIELD.name = "consumable_cds"
GUILDARTIFACT_CONSUMABLE_CDS_FIELD.full_name = ".Cmd.GuildArtifact.consumable_cds"
GUILDARTIFACT_CONSUMABLE_CDS_FIELD.number = 3
GUILDARTIFACT_CONSUMABLE_CDS_FIELD.index = 2
GUILDARTIFACT_CONSUMABLE_CDS_FIELD.label = 3
GUILDARTIFACT_CONSUMABLE_CDS_FIELD.has_default_value = false
GUILDARTIFACT_CONSUMABLE_CDS_FIELD.default_value = {}
GUILDARTIFACT_CONSUMABLE_CDS_FIELD.message_type = GUILDARTIFACTCONSUMABLECD
GUILDARTIFACT_CONSUMABLE_CDS_FIELD.type = 11
GUILDARTIFACT_CONSUMABLE_CDS_FIELD.cpp_type = 10
...
GUILDARTIFACT.fields = {
  ...
  GUILDARTIFACT_CONSUMABLE_CDS_FIELD
}
...
GUILDSUMMARYDATA_SERVERID_FIELD.name = "serverid"
GUILDSUMMARYDATA_SERVERID_FIELD.full_name = ".Cmd.GuildSummaryData.serverid"
GUILDSUMMARYDATA_SERVERID_FIELD.number = 23
GUILDSUMMARYDATA_SERVERID_FIELD.index = 3
GUILDSUMMARYDATA_SERVERID_FIELD.label = 1
GUILDSUMMARYDATA_SERVERID_FIELD.has_default_value = false
GUILDSUMMARYDATA_SERVERID_FIELD.default_value = 0
GUILDSUMMARYDATA_SERVERID_FIELD.type = 13
GUILDSUMMARYDATA_SERVERID_FIELD.cpp_type = 3
...
GUILDSUMMARYDATA_CURMEMBER_FIELD.index = 4
...
GUILDSUMMARYDATA_MAXMEMBER_FIELD.index = 5
...
GUILDSUMMARYDATA_CURMERCENARY_FIELD.index = 6
...
GUILDSUMMARYDATA_CITYID_FIELD.index = 7
...
GUILDSUMMARYDATA_OCCUPY_CITY_FIELD.index = 8
...
GUILDSUMMARYDATA_BATTLE_GROUP_FIELD.index = 9
...
GUILDSUMMARYDATA_NEXT_BATTLE_GROUP_FIELD.index = 10
...
GUILDSUMMARYDATA_CHAIRMANGENDER_FIELD.index = 11
...
GUILDSUMMARYDATA_CHAIRMANNAME_FIELD.index = 12
...
GUILDSUMMARYDATA_GUILDNAME_FIELD.index = 13
...
GUILDSUMMARYDATA_RECRUITINFO_FIELD.index = 14
...
GUILDSUMMARYDATA_PORTRAIT_FIELD.index = 15
...
GUILDSUMMARYDATA_CHAIRMANPORTRAIT_FIELD.index = 16
...
GUILDSUMMARYDATA_GVGLEVEL_FIELD.index = 17
...
GUILDSUMMARYDATA_NEEDLEVEL_FIELD.index = 18
...
GUILDSUMMARYDATA_NEXTZONEID_FIELD.index = 19
...
GUILDSUMMARYDATA_NO_ATTACK_METAL_FIELD.index = 20
...
GUILDSUMMARYDATA_APPLIED_FIELD.index = 21
...
GUILDSUMMARYDATA_MERCENARY_FIELD.index = 22
...
GUILDSUMMARYDATA_CHAIRMANID_FIELD.index = 23
...
GUILDSUMMARYDATA.fields = {
  ...
  GUILDSUMMARYDATA_SERVERID_FIELD,
...
CITYSHOWINFO_ATTACKER_COUNT_FIELD.name = "attacker_count"
CITYSHOWINFO_ATTACKER_COUNT_FIELD.full_name = ".Cmd.CityShowInfo.attacker_count"
CITYSHOWINFO_ATTACKER_COUNT_FIELD.number = 14
CITYSHOWINFO_ATTACKER_COUNT_FIELD.index = 13
CITYSHOWINFO_ATTACKER_COUNT_FIELD.label = 1
CITYSHOWINFO_ATTACKER_COUNT_FIELD.has_default_value = false
CITYSHOWINFO_ATTACKER_COUNT_FIELD.default_value = 0
CITYSHOWINFO_ATTACKER_COUNT_FIELD.type = 13
CITYSHOWINFO_ATTACKER_COUNT_FIELD.cpp_type = 3
CITYSHOWINFO_MY_GUILD_MEMBER_COUNT_FIELD.name = "my_guild_member_count"
CITYSHOWINFO_MY_GUILD_MEMBER_COUNT_FIELD.full_name = ".Cmd.CityShowInfo.my_guild_member_count"
CITYSHOWINFO_MY_GUILD_MEMBER_COUNT_FIELD.number = 15
CITYSHOWINFO_MY_GUILD_MEMBER_COUNT_FIELD.index = 14
CITYSHOWINFO_MY_GUILD_MEMBER_COUNT_FIELD.label = 1
CITYSHOWINFO_MY_GUILD_MEMBER_COUNT_FIELD.has_default_value = false
CITYSHOWINFO_MY_GUILD_MEMBER_COUNT_FIELD.default_value = 0
CITYSHOWINFO_MY_GUILD_MEMBER_COUNT_FIELD.type = 13
CITYSHOWINFO_MY_GUILD_MEMBER_COUNT_FIELD.cpp_type = 3
CITYSHOWINFO_FRIEND_STATE_FIELD.name = "friend_state"
CITYSHOWINFO_FRIEND_STATE_FIELD.full_name = ".Cmd.CityShowInfo.friend_state"
CITYSHOWINFO_FRIEND_STATE_FIELD.number = 16
CITYSHOWINFO_FRIEND_STATE_FIELD.index = 15
CITYSHOWINFO_FRIEND_STATE_FIELD.label = 1
CITYSHOWINFO_FRIEND_STATE_FIELD.has_default_value = false
CITYSHOWINFO_FRIEND_STATE_FIELD.default_value = nil
CITYSHOWINFO_FRIEND_STATE_FIELD.enum_type = EGVGCITYFRIENDSTATE
CITYSHOWINFO_FRIEND_STATE_FIELD.type = 14
CITYSHOWINFO_FRIEND_STATE_FIELD.cpp_type = 8
CITYSHOWINFO_CALM_END_TIME_FIELD.name = "calm_end_time"
CITYSHOWINFO_CALM_END_TIME_FIELD.full_name = ".Cmd.CityShowInfo.calm_end_time"
CITYSHOWINFO_CALM_END_TIME_FIELD.number = 17
CITYSHOWINFO_CALM_END_TIME_FIELD.index = 16
CITYSHOWINFO_CALM_END_TIME_FIELD.label = 1
CITYSHOWINFO_CALM_END_TIME_FIELD.has_default_value = false
CITYSHOWINFO_CALM_END_TIME_FIELD.default_value = 0
CITYSHOWINFO_CALM_END_TIME_FIELD.type = 13
CITYSHOWINFO_CALM_END_TIME_FIELD.cpp_type = 3
...
CITYSHOWINFO.fields = {
  ...
  CITYSHOWINFO_ATTACKER_COUNT_FIELD,
  CITYSHOWINFO_MY_GUILD_MEMBER_COUNT_FIELD,
  CITYSHOWINFO_FRIEND_STATE_FIELD,
  CITYSHOWINFO_CALM_END_TIME_FIELD
}
CITYSHOWINFO.is_extendable = false
CITYSHOWINFO.extensions = {}
USERFRIENDINFO_TEAMID_FIELD.name = "teamid"
USERFRIENDINFO_TEAMID_FIELD.full_name = ".Cmd.UserFriendInfo.teamid"
USERFRIENDINFO_TEAMID_FIELD.number = 1
USERFRIENDINFO_TEAMID_FIELD.index = 0
USERFRIENDINFO_TEAMID_FIELD.label = 1
USERFRIENDINFO_TEAMID_FIELD.has_default_value = false
USERFRIENDINFO_TEAMID_FIELD.default_value = 0
USERFRIENDINFO_TEAMID_FIELD.type = 13
USERFRIENDINFO_TEAMID_FIELD.cpp_type = 3
USERFRIENDINFO_IS_TEAM_LEADER_FIELD.name = "is_team_leader"
USERFRIENDINFO_IS_TEAM_LEADER_FIELD.full_name = ".Cmd.UserFriendInfo.is_team_leader"
USERFRIENDINFO_IS_TEAM_LEADER_FIELD.number = 2
USERFRIENDINFO_IS_TEAM_LEADER_FIELD.index = 1
USERFRIENDINFO_IS_TEAM_LEADER_FIELD.label = 1
USERFRIENDINFO_IS_TEAM_LEADER_FIELD.has_default_value = false
USERFRIENDINFO_IS_TEAM_LEADER_FIELD.default_value = false
USERFRIENDINFO_IS_TEAM_LEADER_FIELD.type = 8
USERFRIENDINFO_IS_TEAM_LEADER_FIELD.cpp_type = 7
USERFRIENDINFO_GROUPID_FIELD.name = "groupid"
USERFRIENDINFO_GROUPID_FIELD.full_name = ".Cmd.UserFriendInfo.groupid"
USERFRIENDINFO_GROUPID_FIELD.number = 3
USERFRIENDINFO_GROUPID_FIELD.index = 2
USERFRIENDINFO_GROUPID_FIELD.label = 1
USERFRIENDINFO_GROUPID_FIELD.has_default_value = false
USERFRIENDINFO_GROUPID_FIELD.default_value = 0
USERFRIENDINFO_GROUPID_FIELD.type = 13
USERFRIENDINFO_GROUPID_FIELD.cpp_type = 3
USERFRIENDINFO_IS_GROUP_LEADER_FIELD.name = "is_group_leader"
USERFRIENDINFO_IS_GROUP_LEADER_FIELD.full_name = ".Cmd.UserFriendInfo.is_group_leader"
USERFRIENDINFO_IS_GROUP_LEADER_FIELD.number = 4
USERFRIENDINFO_IS_GROUP_LEADER_FIELD.index = 3
USERFRIENDINFO_IS_GROUP_LEADER_FIELD.label = 1
USERFRIENDINFO_IS_GROUP_LEADER_FIELD.has_default_value = false
USERFRIENDINFO_IS_GROUP_LEADER_FIELD.default_value = false
USERFRIENDINFO_IS_GROUP_LEADER_FIELD.type = 8
USERFRIENDINFO_IS_GROUP_LEADER_FIELD.cpp_type = 7
USERFRIENDINFO_GUILDID_FIELD.name = "guildid"
USERFRIENDINFO_GUILDID_FIELD.full_name = ".Cmd.UserFriendInfo.guildid"
USERFRIENDINFO_GUILDID_FIELD.number = 5
USERFRIENDINFO_GUILDID_FIELD.index = 4
USERFRIENDINFO_GUILDID_FIELD.label = 1
USERFRIENDINFO_GUILDID_FIELD.has_default_value = false
USERFRIENDINFO_GUILDID_FIELD.default_value = 0
USERFRIENDINFO_GUILDID_FIELD.type = 13
USERFRIENDINFO_GUILDID_FIELD.cpp_type = 3
USERFRIENDINFO_IS_GUILD_CHAIRMAN_FIELD.name = "is_guild_chairman"
USERFRIENDINFO_IS_GUILD_CHAIRMAN_FIELD.full_name = ".Cmd.UserFriendInfo.is_guild_chairman"
USERFRIENDINFO_IS_GUILD_CHAIRMAN_FIELD.number = 6
USERFRIENDINFO_IS_GUILD_CHAIRMAN_FIELD.index = 5
USERFRIENDINFO_IS_GUILD_CHAIRMAN_FIELD.label = 1
USERFRIENDINFO_IS_GUILD_CHAIRMAN_FIELD.has_default_value = false
USERFRIENDINFO_IS_GUILD_CHAIRMAN_FIELD.default_value = false
USERFRIENDINFO_IS_GUILD_CHAIRMAN_FIELD.type = 8
USERFRIENDINFO_IS_GUILD_CHAIRMAN_FIELD.cpp_type = 7
USERFRIENDINFO.name = "UserFriendInfo"
USERFRIENDINFO.full_name = ".Cmd.UserFriendInfo"
USERFRIENDINFO.nested_types = {}
USERFRIENDINFO.enum_types = {}
USERFRIENDINFO.fields = {
  USERFRIENDINFO_TEAMID_FIELD,
  USERFRIENDINFO_IS_TEAM_LEADER_FIELD,
  USERFRIENDINFO_GROUPID_FIELD,
  USERFRIENDINFO_IS_GROUP_LEADER_FIELD,
  USERFRIENDINFO_GUILDID_FIELD,
  USERFRIENDINFO_IS_GUILD_CHAIRMAN_FIELD
}
USERFRIENDINFO.is_extendable = false
USERFRIENDINFO.extensions = {}
...
QUERYGCITYSHOWINFOGUILDCMD_QUERY_TYPE_FIELD.name = "query_type"
QUERYGCITYSHOWINFOGUILDCMD_QUERY_TYPE_FIELD.full_name = ".Cmd.QueryGCityShowInfoGuildCmd.query_type"
QUERYGCITYSHOWINFOGUILDCMD_QUERY_TYPE_FIELD.number = 5
QUERYGCITYSHOWINFOGUILDCMD_QUERY_TYPE_FIELD.index = 4
QUERYGCITYSHOWINFOGUILDCMD_QUERY_TYPE_FIELD.label = 1
QUERYGCITYSHOWINFOGUILDCMD_QUERY_TYPE_FIELD.has_default_value = false
QUERYGCITYSHOWINFOGUILDCMD_QUERY_TYPE_FIELD.default_value = nil
QUERYGCITYSHOWINFOGUILDCMD_QUERY_TYPE_FIELD.enum_type = ECITYINFOQUERYTYPE
QUERYGCITYSHOWINFOGUILDCMD_QUERY_TYPE_FIELD.type = 14
QUERYGCITYSHOWINFOGUILDCMD_QUERY_TYPE_FIELD.cpp_type = 8
QUERYGCITYSHOWINFOGUILDCMD_FRIEND_INFO_FIELD.name = "friend_info"
QUERYGCITYSHOWINFOGUILDCMD_FRIEND_INFO_FIELD.full_name = ".Cmd.QueryGCityShowInfoGuildCmd.friend_info"
QUERYGCITYSHOWINFOGUILDCMD_FRIEND_INFO_FIELD.number = 6
QUERYGCITYSHOWINFOGUILDCMD_FRIEND_INFO_FIELD.index = 5
QUERYGCITYSHOWINFOGUILDCMD_FRIEND_INFO_FIELD.label = 1
QUERYGCITYSHOWINFOGUILDCMD_FRIEND_INFO_FIELD.has_default_value = false
QUERYGCITYSHOWINFOGUILDCMD_FRIEND_INFO_FIELD.default_value = nil
QUERYGCITYSHOWINFOGUILDCMD_FRIEND_INFO_FIELD.message_type = USERFRIENDINFO
QUERYGCITYSHOWINFOGUILDCMD_FRIEND_INFO_FIELD.type = 11
QUERYGCITYSHOWINFOGUILDCMD_FRIEND_INFO_FIELD.cpp_type = 10
...
QUERYGCITYSHOWINFOGUILDCMD.fields = {
  ...
  QUERYGCITYSHOWINFOGUILDCMD_QUERY_TYPE_FIELD,
  QUERYGCITYSHOWINFOGUILDCMD_FRIEND_INFO_FIELD
}
...
GVGOPENFIREGUILDCMD_TIMEZONEID_FIELD.name = "timezoneid"
GVGOPENFIREGUILDCMD_TIMEZONEID_FIELD.full_name = ".Cmd.GvgOpenFireGuildCmd.timezoneid"
GVGOPENFIREGUILDCMD_TIMEZONEID_FIELD.number = 6
GVGOPENFIREGUILDCMD_TIMEZONEID_FIELD.index = 5
GVGOPENFIREGUILDCMD_TIMEZONEID_FIELD.label = 1
GVGOPENFIREGUILDCMD_TIMEZONEID_FIELD.has_default_value = false
GVGOPENFIREGUILDCMD_TIMEZONEID_FIELD.default_value = 0
GVGOPENFIREGUILDCMD_TIMEZONEID_FIELD.type = 13
GVGOPENFIREGUILDCMD_TIMEZONEID_FIELD.cpp_type = 3
...
GVGOPENFIREGUILDCMD.fields = {
  ...
  GVGOPENFIREGUILDCMD_TIMEZONEID_FIELD
}
...
SUPERGVGGUILDDATA_SERVERID_FIELD.name = "serverid"
SUPERGVGGUILDDATA_SERVERID_FIELD.full_name = ".Cmd.SuperGvgGuildData.serverid"
SUPERGVGGUILDDATA_SERVERID_FIELD.number = 7
SUPERGVGGUILDDATA_SERVERID_FIELD.index = 6
SUPERGVGGUILDDATA_SERVERID_FIELD.label = 1
SUPERGVGGUILDDATA_SERVERID_FIELD.has_default_value = false
SUPERGVGGUILDDATA_SERVERID_FIELD.default_value = 0
SUPERGVGGUILDDATA_SERVERID_FIELD.type = 13
SUPERGVGGUILDDATA_SERVERID_FIELD.cpp_type = 3
...
SUPERGVGGUILDDATA.fields = {
  ...
  SUPERGVGGUILDDATA_SERVERID_FIELD
}
...
GUILDSHOWINFO_SERVERID_FIELD.name = "serverid"
GUILDSHOWINFO_SERVERID_FIELD.full_name = ".Cmd.GuildShowInfo.serverid"
GUILDSHOWINFO_SERVERID_FIELD.number = 8
GUILDSHOWINFO_SERVERID_FIELD.index = 7
GUILDSHOWINFO_SERVERID_FIELD.label = 1
GUILDSHOWINFO_SERVERID_FIELD.has_default_value = false
GUILDSHOWINFO_SERVERID_FIELD.default_value = 0
GUILDSHOWINFO_SERVERID_FIELD.type = 13
GUILDSHOWINFO_SERVERID_FIELD.cpp_type = 3
...
DATEBATTLEEXTRAINFO_TYPE_FIELD.name = "type"
DATEBATTLEEXTRAINFO_TYPE_FIELD.full_name = ".Cmd.DateBattleExtraInfo.type"
DATEBATTLEEXTRAINFO_TYPE_FIELD.number = 1
DATEBATTLEEXTRAINFO_TYPE_FIELD.index = 0
DATEBATTLEEXTRAINFO_TYPE_FIELD.label = 1
DATEBATTLEEXTRAINFO_TYPE_FIELD.has_default_value = false
DATEBATTLEEXTRAINFO_TYPE_FIELD.default_value = nil
DATEBATTLEEXTRAINFO_TYPE_FIELD.enum_type = EGUILDDATEBATTLETYPE
DATEBATTLEEXTRAINFO_TYPE_FIELD.type = 14
DATEBATTLEEXTRAINFO_TYPE_FIELD.cpp_type = 8
DATEBATTLEEXTRAINFO_TARGET_NUM_FIELD.name = "target_num"
DATEBATTLEEXTRAINFO_TARGET_NUM_FIELD.full_name = ".Cmd.DateBattleExtraInfo.target_num"
DATEBATTLEEXTRAINFO_TARGET_NUM_FIELD.number = 2
DATEBATTLEEXTRAINFO_TARGET_NUM_FIELD.index = 1
DATEBATTLEEXTRAINFO_TARGET_NUM_FIELD.label = 1
DATEBATTLEEXTRAINFO_TARGET_NUM_FIELD.has_default_value = false
DATEBATTLEEXTRAINFO_TARGET_NUM_FIELD.default_value = 0
DATEBATTLEEXTRAINFO_TARGET_NUM_FIELD.type = 13
DATEBATTLEEXTRAINFO_TARGET_NUM_FIELD.cpp_type = 3
DATEBATTLEEXTRAINFO_CARDIDS_FIELD.name = "cardids"
DATEBATTLEEXTRAINFO_CARDIDS_FIELD.full_name = ".Cmd.DateBattleExtraInfo.cardids"
DATEBATTLEEXTRAINFO_CARDIDS_FIELD.number = 3
DATEBATTLEEXTRAINFO_CARDIDS_FIELD.index = 2
DATEBATTLEEXTRAINFO_CARDIDS_FIELD.label = 3
DATEBATTLEEXTRAINFO_CARDIDS_FIELD.has_default_value = false
DATEBATTLEEXTRAINFO_CARDIDS_FIELD.default_value = {}
DATEBATTLEEXTRAINFO_CARDIDS_FIELD.type = 13
DATEBATTLEEXTRAINFO_CARDIDS_FIELD.cpp_type = 3
DATEBATTLEEXTRAINFO.name = "DateBattleExtraInfo"
DATEBATTLEEXTRAINFO.full_name = ".Cmd.DateBattleExtraInfo"
DATEBATTLEEXTRAINFO.nested_types = {}
DATEBATTLEEXTRAINFO.enum_types = {}
DATEBATTLEEXTRAINFO.fields = {
  DATEBATTLEEXTRAINFO_TYPE_FIELD,
  DATEBATTLEEXTRAINFO_TARGET_NUM_FIELD,
  DATEBATTLEEXTRAINFO_CARDIDS_FIELD
}
DATEBATTLEEXTRAINFO.is_extendable = false
DATEBATTLEEXTRAINFO.extensions = {}
...
DATEBATTLEDATA_INFO_FIELD.name = "info"
DATEBATTLEDATA_INFO_FIELD.full_name = ".Cmd.DateBattleData.info"
DATEBATTLEDATA_INFO_FIELD.number = 17
DATEBATTLEDATA_INFO_FIELD.index = 16
DATEBATTLEDATA_INFO_FIELD.label = 1
DATEBATTLEDATA_INFO_FIELD.has_default_value = false
DATEBATTLEDATA_INFO_FIELD.default_value = nil
DATEBATTLEDATA_INFO_FIELD.message_type = DATEBATTLEEXTRAINFO
DATEBATTLEDATA_INFO_FIELD.type = 11
DATEBATTLEDATA_INFO_FIELD.cpp_type = 10
...
DATEBATTLEINVITEGUILDCMD_INFO_FIELD.name = "info"
DATEBATTLEINVITEGUILDCMD_INFO_FIELD.full_name = ".Cmd.DateBattleInviteGuildCmd.info"
DATEBATTLEINVITEGUILDCMD_INFO_FIELD.number = 7
DATEBATTLEINVITEGUILDCMD_INFO_FIELD.index = 6
DATEBATTLEINVITEGUILDCMD_INFO_FIELD.label = 1
DATEBATTLEINVITEGUILDCMD_INFO_FIELD.has_default_value = false
DATEBATTLEINVITEGUILDCMD_INFO_FIELD.default_value = nil
DATEBATTLEINVITEGUILDCMD_INFO_FIELD.message_type = DATEBATTLEEXTRAINFO
DATEBATTLEINVITEGUILDCMD_INFO_FIELD.type = 11
DATEBATTLEINVITEGUILDCMD_INFO_FIELD.cpp_type = 10
...
DATEBATTLEINVITEGUILDCMD.fields = {
  ...
  DATEBATTLEINVITEGUILDCMD_INFO_FIELD
}
...
DATEBATTLEREPORTGUILDCMD_DEATH_COUNT_FIELD.name = "death_count"
DATEBATTLEREPORTGUILDCMD_DEATH_COUNT_FIELD.full_name = ".Cmd.DateBattleReportGuildCmd.death_count"
DATEBATTLEREPORTGUILDCMD_DEATH_COUNT_FIELD.number = 7
DATEBATTLEREPORTGUILDCMD_DEATH_COUNT_FIELD.index = 6
DATEBATTLEREPORTGUILDCMD_DEATH_COUNT_FIELD.label = 1
DATEBATTLEREPORTGUILDCMD_DEATH_COUNT_FIELD.has_default_value = false
DATEBATTLEREPORTGUILDCMD_DEATH_COUNT_FIELD.default_value = 0
DATEBATTLEREPORTGUILDCMD_DEATH_COUNT_FIELD.type = 13
DATEBATTLEREPORTGUILDCMD_DEATH_COUNT_FIELD.cpp_type = 3
DATEBATTLEREPORTGUILDCMD_ATK_KILL_COUNT_FIELD.name = "atk_kill_count"
DATEBATTLEREPORTGUILDCMD_ATK_KILL_COUNT_FIELD.full_name = ".Cmd.DateBattleReportGuildCmd.atk_kill_count"
DATEBATTLEREPORTGUILDCMD_ATK_KILL_COUNT_FIELD.number = 8
DATEBATTLEREPORTGUILDCMD_ATK_KILL_COUNT_FIELD.index = 7
DATEBATTLEREPORTGUILDCMD_ATK_KILL_COUNT_FIELD.label = 1
DATEBATTLEREPORTGUILDCMD_ATK_KILL_COUNT_FIELD.has_default_value = false
DATEBATTLEREPORTGUILDCMD_ATK_KILL_COUNT_FIELD.default_value = 0
DATEBATTLEREPORTGUILDCMD_ATK_KILL_COUNT_FIELD.type = 13
DATEBATTLEREPORTGUILDCMD_ATK_KILL_COUNT_FIELD.cpp_type = 3
DATEBATTLEREPORTGUILDCMD_DEF_KILL_COUNT_FIELD.name = "def_kill_count"
DATEBATTLEREPORTGUILDCMD_DEF_KILL_COUNT_FIELD.full_name = ".Cmd.DateBattleReportGuildCmd.def_kill_count"
DATEBATTLEREPORTGUILDCMD_DEF_KILL_COUNT_FIELD.number = 9
DATEBATTLEREPORTGUILDCMD_DEF_KILL_COUNT_FIELD.index = 8
DATEBATTLEREPORTGUILDCMD_DEF_KILL_COUNT_FIELD.label = 1
DATEBATTLEREPORTGUILDCMD_DEF_KILL_COUNT_FIELD.has_default_value = false
DATEBATTLEREPORTGUILDCMD_DEF_KILL_COUNT_FIELD.default_value = 0
DATEBATTLEREPORTGUILDCMD_DEF_KILL_COUNT_FIELD.type = 13
DATEBATTLEREPORTGUILDCMD_DEF_KILL_COUNT_FIELD.cpp_type = 3
...
DATEBATTLEREPORTGUILDCMD.fields = {
  ...
  DATEBATTLEREPORTGUILDCMD_DEATH_COUNT_FIELD,
  DATEBATTLEREPORTGUILDCMD_ATK_KILL_COUNT_FIELD,
  DATEBATTLEREPORTGUILDCMD_DEF_KILL_COUNT_FIELD
}
...
DateBattleExtraInfo = protobuf.Message(DATEBATTLEEXTRAINFO)
...
ECITYACTION_MAX = 3
ECITYACTION_MIN = 0
ECITYINFOQUERYTYPE_NORMAL = 0
ECITYINFOQUERYTYPE_UI_CLOSE = 2
ECITYINFOQUERYTYPE_UI_OPEN = 1
ECOOKING_HEAT = 2
...
EGUILDDATEBATTLETYPE_BASE = 1
EGUILDDATEBATTLETYPE_BLOOD = 3
EGUILDDATEBATTLETYPE_DEATH = 2
EGUILDDATEBATTLETYPE_MIN = 0
...
EGUILDMEMBERDATA_HEAD_FASHION = 39
...
EGUILDMEMBERDATA_SNOW_ROOMID = 40
...
EGVG_CITY_FRIEND_STATE_GROUP_LEADER = 2
EGVG_CITY_FRIEND_STATE_GUILD_CHAIRMAN = 3
EGVG_CITY_FRIEND_STATE_MAX = 4
EGVG_CITY_FRIEND_STATE_MIN = 0
EGVG_CITY_FRIEND_STATE_TEAM_LEADER = 1
EICON_FORBID = 2
EICON_INIT = 0
EICON_PASS = 1
EMODIFY_AUTH = 1
...
GUILDPARAM_GVG_CITYINFO_OPEN = 117
...
GuildArtifactConsumableCD = protobuf.Message(GUILDARTIFACTCONSUMABLECD)
