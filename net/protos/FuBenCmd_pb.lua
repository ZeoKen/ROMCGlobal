...
FUBENPARAM_SNOW_REALM_PARTY_SYNC_ENUM = protobuf.EnumValueDescriptor()
FUBENPARAM_SNOW_REALM_DAMAGE_RANK_SYNC_ENUM = protobuf.EnumValueDescriptor()
ESNOWREALMPARTYSTAGE = protobuf.EnumDescriptor()
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_MIN_ENUM = protobuf.EnumValueDescriptor()
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_PREPARE_ENUM = protobuf.EnumValueDescriptor()
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_MONSTER_ENUM = protobuf.EnumValueDescriptor()
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_BOSS_ENUM = protobuf.EnumValueDescriptor()
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_SUCCESS_ENUM = protobuf.EnumValueDescriptor()
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_FAIL_ENUM = protobuf.EnumValueDescriptor()
...
ERAIDTYPE_ERAIDTYPE_ICE_LAB_ENUM = protobuf.EnumValueDescriptor()
...
EPVEGROUPTYPE_EPVEGROUPTYPE_ICE_LAB_ENUM = protobuf.EnumValueDescriptor()
...
EROLLRAIDREWARDTYPE_EROLLRAIDREWARD_ICE_LAB_ENUM = protobuf.EnumValueDescriptor()
...
SNOWREALMPARTYSYNCFUBENCMD = protobuf.Descriptor()
SNOWREALMPARTYSYNCFUBENCMD_CMD_FIELD = protobuf.FieldDescriptor()
SNOWREALMPARTYSYNCFUBENCMD_PARAM_FIELD = protobuf.FieldDescriptor()
SNOWREALMPARTYSYNCFUBENCMD_STAGE_FIELD = protobuf.FieldDescriptor()
SNOWREALMPARTYSYNCFUBENCMD_TRANSFORMED_USER_FIELD = protobuf.FieldDescriptor()
SNOWREALMPARTYSYNCFUBENCMD_TOTAL_USER_FIELD = protobuf.FieldDescriptor()
SNOWREALMPARTYSYNCFUBENCMD_KILLED_MONSTER_FIELD = protobuf.FieldDescriptor()
SNOWREALMPARTYSYNCFUBENCMD_TOTAL_MONSTER_FIELD = protobuf.FieldDescriptor()
SNOWREALMPARTYSYNCFUBENCMD_BOSS_GUID_FIELD = protobuf.FieldDescriptor()
SNOWREALMPARTYSYNCFUBENCMD_END_TIME_FIELD = protobuf.FieldDescriptor()
SNOWREALMPARTYSYNCFUBENCMD_IS_FINISH_FIELD = protobuf.FieldDescriptor()
SNOWREALMDAMAGERANKDATA = protobuf.Descriptor()
SNOWREALMDAMAGERANKDATA_CHARID_FIELD = protobuf.FieldDescriptor()
SNOWREALMDAMAGERANKDATA_CHARNAME_FIELD = protobuf.FieldDescriptor()
SNOWREALMDAMAGERANKDATA_DAMAGE_FIELD = protobuf.FieldDescriptor()
SNOWREALMDAMAGERANKSYNCFUBENCMD = protobuf.Descriptor()
SNOWREALMDAMAGERANKSYNCFUBENCMD_CMD_FIELD = protobuf.FieldDescriptor()
SNOWREALMDAMAGERANKSYNCFUBENCMD_PARAM_FIELD = protobuf.FieldDescriptor()
SNOWREALMDAMAGERANKSYNCFUBENCMD_DATAS_FIELD = protobuf.FieldDescriptor()
...
FUBENPARAM_SNOW_REALM_PARTY_SYNC_ENUM.name = "SNOW_REALM_PARTY_SYNC"
FUBENPARAM_SNOW_REALM_PARTY_SYNC_ENUM.index = 179
FUBENPARAM_SNOW_REALM_PARTY_SYNC_ENUM.number = 192
FUBENPARAM_SNOW_REALM_DAMAGE_RANK_SYNC_ENUM.name = "SNOW_REALM_DAMAGE_RANK_SYNC"
FUBENPARAM_SNOW_REALM_DAMAGE_RANK_SYNC_ENUM.index = 180
FUBENPARAM_SNOW_REALM_DAMAGE_RANK_SYNC_ENUM.number = 193
...
FUBENPARAM.values = {
  ...
  FUBENPARAM_SNOW_REALM_PARTY_SYNC_ENUM,
  FUBENPARAM_SNOW_REALM_DAMAGE_RANK_SYNC_ENUM
}
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_MIN_ENUM.name = "ESNOW_REALM_PARTY_STAGE_MIN"
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_MIN_ENUM.index = 0
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_MIN_ENUM.number = 0
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_PREPARE_ENUM.name = "ESNOW_REALM_PARTY_STAGE_PREPARE"
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_PREPARE_ENUM.index = 1
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_PREPARE_ENUM.number = 1
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_MONSTER_ENUM.name = "ESNOW_REALM_PARTY_STAGE_MONSTER"
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_MONSTER_ENUM.index = 2
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_MONSTER_ENUM.number = 2
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_BOSS_ENUM.name = "ESNOW_REALM_PARTY_STAGE_BOSS"
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_BOSS_ENUM.index = 3
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_BOSS_ENUM.number = 3
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_SUCCESS_ENUM.name = "ESNOW_REALM_PARTY_STAGE_SUCCESS"
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_SUCCESS_ENUM.index = 4
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_SUCCESS_ENUM.number = 4
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_FAIL_ENUM.name = "ESNOW_REALM_PARTY_STAGE_FAIL"
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_FAIL_ENUM.index = 5
ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_FAIL_ENUM.number = 5
ESNOWREALMPARTYSTAGE.name = "ESnowRealmPartyStage"
ESNOWREALMPARTYSTAGE.full_name = ".Cmd.ESnowRealmPartyStage"
ESNOWREALMPARTYSTAGE.values = {
  ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_MIN_ENUM,
  ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_PREPARE_ENUM,
  ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_MONSTER_ENUM,
  ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_BOSS_ENUM,
  ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_SUCCESS_ENUM,
  ESNOWREALMPARTYSTAGE_ESNOW_REALM_PARTY_STAGE_FAIL_ENUM
}
...
ERAIDTYPE_ERAIDTYPE_ICE_LAB_ENUM.name = "ERAIDTYPE_ICE_LAB"
ERAIDTYPE_ERAIDTYPE_ICE_LAB_ENUM.index = 81
ERAIDTYPE_ERAIDTYPE_ICE_LAB_ENUM.number = 90
ERAIDTYPE_ERAIDTYPE_LOTTERY_RAID_ENUM.name = "ERAIDTYPE_LOTTERY_RAID"
ERAIDTYPE_ERAIDTYPE_LOTTERY_RAID_ENUM.index = 82
ERAIDTYPE_ERAIDTYPE_LOTTERY_RAID_ENUM.number = 91
ERAIDTYPE_ERAIDTYPE_MAX_ENUM.name = "ERAIDTYPE_MAX"
ERAIDTYPE_ERAIDTYPE_MAX_ENUM.index = 83
...
ERAIDTYPE.values = {
  ...
  ERAIDTYPE_ERAIDTYPE_ICE_LAB_ENUM,
...
EPVEGROUPTYPE_EPVEGROUPTYPE_ICE_LAB_ENUM.name = "EPVEGROUPTYPE_ICE_LAB"
EPVEGROUPTYPE_EPVEGROUPTYPE_ICE_LAB_ENUM.index = 49
EPVEGROUPTYPE_EPVEGROUPTYPE_ICE_LAB_ENUM.number = 49
EPVEGROUPTYPE_EPVEGROUPTYPE_LOTTERY_RAID_ENUM.name = "EPVEGROUPTYPE_LOTTERY_RAID"
EPVEGROUPTYPE_EPVEGROUPTYPE_LOTTERY_RAID_ENUM.index = 50
EPVEGROUPTYPE_EPVEGROUPTYPE_LOTTERY_RAID_ENUM.number = 50
EPVEGROUPTYPE_EPVEGROUPTYPE_MAX_ENUM.name = "EPVEGROUPTYPE_MAX"
EPVEGROUPTYPE_EPVEGROUPTYPE_MAX_ENUM.index = 51
...
EPVEGROUPTYPE.values = {
  ...
  EPVEGROUPTYPE_EPVEGROUPTYPE_ICE_LAB_ENUM,
...
EROLLRAIDREWARDTYPE_EROLLRAIDREWARD_ICE_LAB_ENUM.name = "EROLLRAIDREWARD_ICE_LAB"
EROLLRAIDREWARDTYPE_EROLLRAIDREWARD_ICE_LAB_ENUM.index = 16
EROLLRAIDREWARDTYPE_EROLLRAIDREWARD_ICE_LAB_ENUM.number = 16
EROLLRAIDREWARDTYPE_EROLLRAIDREWARD_LOTTERY_RAID_ENUM.name = "EROLLRAIDREWARD_LOTTERY_RAID"
EROLLRAIDREWARDTYPE_EROLLRAIDREWARD_LOTTERY_RAID_ENUM.index = 17
...
EROLLRAIDREWARDTYPE.values = {
  ...
  EROLLRAIDREWARDTYPE_EROLLRAIDREWARD_ICE_LAB_ENUM,
...
SNOWREALMPARTYSYNCFUBENCMD_CMD_FIELD.name = "cmd"
SNOWREALMPARTYSYNCFUBENCMD_CMD_FIELD.full_name = ".Cmd.SnowRealmPartySyncFubenCmd.cmd"
SNOWREALMPARTYSYNCFUBENCMD_CMD_FIELD.number = 1
SNOWREALMPARTYSYNCFUBENCMD_CMD_FIELD.index = 0
SNOWREALMPARTYSYNCFUBENCMD_CMD_FIELD.label = 1
SNOWREALMPARTYSYNCFUBENCMD_CMD_FIELD.has_default_value = true
SNOWREALMPARTYSYNCFUBENCMD_CMD_FIELD.default_value = 11
SNOWREALMPARTYSYNCFUBENCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
SNOWREALMPARTYSYNCFUBENCMD_CMD_FIELD.type = 14
SNOWREALMPARTYSYNCFUBENCMD_CMD_FIELD.cpp_type = 8
SNOWREALMPARTYSYNCFUBENCMD_PARAM_FIELD.name = "param"
SNOWREALMPARTYSYNCFUBENCMD_PARAM_FIELD.full_name = ".Cmd.SnowRealmPartySyncFubenCmd.param"
SNOWREALMPARTYSYNCFUBENCMD_PARAM_FIELD.number = 2
SNOWREALMPARTYSYNCFUBENCMD_PARAM_FIELD.index = 1
SNOWREALMPARTYSYNCFUBENCMD_PARAM_FIELD.label = 1
SNOWREALMPARTYSYNCFUBENCMD_PARAM_FIELD.has_default_value = true
SNOWREALMPARTYSYNCFUBENCMD_PARAM_FIELD.default_value = 192
SNOWREALMPARTYSYNCFUBENCMD_PARAM_FIELD.enum_type = FUBENPARAM
SNOWREALMPARTYSYNCFUBENCMD_PARAM_FIELD.type = 14
SNOWREALMPARTYSYNCFUBENCMD_PARAM_FIELD.cpp_type = 8
SNOWREALMPARTYSYNCFUBENCMD_STAGE_FIELD.name = "stage"
SNOWREALMPARTYSYNCFUBENCMD_STAGE_FIELD.full_name = ".Cmd.SnowRealmPartySyncFubenCmd.stage"
SNOWREALMPARTYSYNCFUBENCMD_STAGE_FIELD.number = 3
SNOWREALMPARTYSYNCFUBENCMD_STAGE_FIELD.index = 2
SNOWREALMPARTYSYNCFUBENCMD_STAGE_FIELD.label = 1
SNOWREALMPARTYSYNCFUBENCMD_STAGE_FIELD.has_default_value = true
SNOWREALMPARTYSYNCFUBENCMD_STAGE_FIELD.default_value = 0
SNOWREALMPARTYSYNCFUBENCMD_STAGE_FIELD.enum_type = ESNOWREALMPARTYSTAGE
SNOWREALMPARTYSYNCFUBENCMD_STAGE_FIELD.type = 14
SNOWREALMPARTYSYNCFUBENCMD_STAGE_FIELD.cpp_type = 8
SNOWREALMPARTYSYNCFUBENCMD_TRANSFORMED_USER_FIELD.name = "transformed_user"
SNOWREALMPARTYSYNCFUBENCMD_TRANSFORMED_USER_FIELD.full_name = ".Cmd.SnowRealmPartySyncFubenCmd.transformed_user"
SNOWREALMPARTYSYNCFUBENCMD_TRANSFORMED_USER_FIELD.number = 4
SNOWREALMPARTYSYNCFUBENCMD_TRANSFORMED_USER_FIELD.index = 3
SNOWREALMPARTYSYNCFUBENCMD_TRANSFORMED_USER_FIELD.label = 1
SNOWREALMPARTYSYNCFUBENCMD_TRANSFORMED_USER_FIELD.has_default_value = false
SNOWREALMPARTYSYNCFUBENCMD_TRANSFORMED_USER_FIELD.default_value = 0
SNOWREALMPARTYSYNCFUBENCMD_TRANSFORMED_USER_FIELD.type = 13
SNOWREALMPARTYSYNCFUBENCMD_TRANSFORMED_USER_FIELD.cpp_type = 3
SNOWREALMPARTYSYNCFUBENCMD_TOTAL_USER_FIELD.name = "total_user"
SNOWREALMPARTYSYNCFUBENCMD_TOTAL_USER_FIELD.full_name = ".Cmd.SnowRealmPartySyncFubenCmd.total_user"
SNOWREALMPARTYSYNCFUBENCMD_TOTAL_USER_FIELD.number = 5
SNOWREALMPARTYSYNCFUBENCMD_TOTAL_USER_FIELD.index = 4
SNOWREALMPARTYSYNCFUBENCMD_TOTAL_USER_FIELD.label = 1
SNOWREALMPARTYSYNCFUBENCMD_TOTAL_USER_FIELD.has_default_value = false
SNOWREALMPARTYSYNCFUBENCMD_TOTAL_USER_FIELD.default_value = 0
SNOWREALMPARTYSYNCFUBENCMD_TOTAL_USER_FIELD.type = 13
SNOWREALMPARTYSYNCFUBENCMD_TOTAL_USER_FIELD.cpp_type = 3
SNOWREALMPARTYSYNCFUBENCMD_KILLED_MONSTER_FIELD.name = "killed_monster"
SNOWREALMPARTYSYNCFUBENCMD_KILLED_MONSTER_FIELD.full_name = ".Cmd.SnowRealmPartySyncFubenCmd.killed_monster"
SNOWREALMPARTYSYNCFUBENCMD_KILLED_MONSTER_FIELD.number = 6
SNOWREALMPARTYSYNCFUBENCMD_KILLED_MONSTER_FIELD.index = 5
SNOWREALMPARTYSYNCFUBENCMD_KILLED_MONSTER_FIELD.label = 1
SNOWREALMPARTYSYNCFUBENCMD_KILLED_MONSTER_FIELD.has_default_value = false
SNOWREALMPARTYSYNCFUBENCMD_KILLED_MONSTER_FIELD.default_value = 0
SNOWREALMPARTYSYNCFUBENCMD_KILLED_MONSTER_FIELD.type = 13
SNOWREALMPARTYSYNCFUBENCMD_KILLED_MONSTER_FIELD.cpp_type = 3
SNOWREALMPARTYSYNCFUBENCMD_TOTAL_MONSTER_FIELD.name = "total_monster"
SNOWREALMPARTYSYNCFUBENCMD_TOTAL_MONSTER_FIELD.full_name = ".Cmd.SnowRealmPartySyncFubenCmd.total_monster"
SNOWREALMPARTYSYNCFUBENCMD_TOTAL_MONSTER_FIELD.number = 7
SNOWREALMPARTYSYNCFUBENCMD_TOTAL_MONSTER_FIELD.index = 6
SNOWREALMPARTYSYNCFUBENCMD_TOTAL_MONSTER_FIELD.label = 1
SNOWREALMPARTYSYNCFUBENCMD_TOTAL_MONSTER_FIELD.has_default_value = false
SNOWREALMPARTYSYNCFUBENCMD_TOTAL_MONSTER_FIELD.default_value = 0
SNOWREALMPARTYSYNCFUBENCMD_TOTAL_MONSTER_FIELD.type = 13
SNOWREALMPARTYSYNCFUBENCMD_TOTAL_MONSTER_FIELD.cpp_type = 3
SNOWREALMPARTYSYNCFUBENCMD_BOSS_GUID_FIELD.name = "boss_guid"
SNOWREALMPARTYSYNCFUBENCMD_BOSS_GUID_FIELD.full_name = ".Cmd.SnowRealmPartySyncFubenCmd.boss_guid"
SNOWREALMPARTYSYNCFUBENCMD_BOSS_GUID_FIELD.number = 8
SNOWREALMPARTYSYNCFUBENCMD_BOSS_GUID_FIELD.index = 7
SNOWREALMPARTYSYNCFUBENCMD_BOSS_GUID_FIELD.label = 1
SNOWREALMPARTYSYNCFUBENCMD_BOSS_GUID_FIELD.has_default_value = false
SNOWREALMPARTYSYNCFUBENCMD_BOSS_GUID_FIELD.default_value = 0
SNOWREALMPARTYSYNCFUBENCMD_BOSS_GUID_FIELD.type = 4
SNOWREALMPARTYSYNCFUBENCMD_BOSS_GUID_FIELD.cpp_type = 4
SNOWREALMPARTYSYNCFUBENCMD_END_TIME_FIELD.name = "end_time"
SNOWREALMPARTYSYNCFUBENCMD_END_TIME_FIELD.full_name = ".Cmd.SnowRealmPartySyncFubenCmd.end_time"
SNOWREALMPARTYSYNCFUBENCMD_END_TIME_FIELD.number = 9
SNOWREALMPARTYSYNCFUBENCMD_END_TIME_FIELD.index = 8
SNOWREALMPARTYSYNCFUBENCMD_END_TIME_FIELD.label = 1
SNOWREALMPARTYSYNCFUBENCMD_END_TIME_FIELD.has_default_value = false
SNOWREALMPARTYSYNCFUBENCMD_END_TIME_FIELD.default_value = 0
SNOWREALMPARTYSYNCFUBENCMD_END_TIME_FIELD.type = 13
SNOWREALMPARTYSYNCFUBENCMD_END_TIME_FIELD.cpp_type = 3
SNOWREALMPARTYSYNCFUBENCMD_IS_FINISH_FIELD.name = "is_finish"
SNOWREALMPARTYSYNCFUBENCMD_IS_FINISH_FIELD.full_name = ".Cmd.SnowRealmPartySyncFubenCmd.is_finish"
SNOWREALMPARTYSYNCFUBENCMD_IS_FINISH_FIELD.number = 10
SNOWREALMPARTYSYNCFUBENCMD_IS_FINISH_FIELD.index = 9
SNOWREALMPARTYSYNCFUBENCMD_IS_FINISH_FIELD.label = 1
SNOWREALMPARTYSYNCFUBENCMD_IS_FINISH_FIELD.has_default_value = false
SNOWREALMPARTYSYNCFUBENCMD_IS_FINISH_FIELD.default_value = false
SNOWREALMPARTYSYNCFUBENCMD_IS_FINISH_FIELD.type = 8
SNOWREALMPARTYSYNCFUBENCMD_IS_FINISH_FIELD.cpp_type = 7
SNOWREALMPARTYSYNCFUBENCMD.name = "SnowRealmPartySyncFubenCmd"
SNOWREALMPARTYSYNCFUBENCMD.full_name = ".Cmd.SnowRealmPartySyncFubenCmd"
SNOWREALMPARTYSYNCFUBENCMD.nested_types = {}
SNOWREALMPARTYSYNCFUBENCMD.enum_types = {}
SNOWREALMPARTYSYNCFUBENCMD.fields = {
  SNOWREALMPARTYSYNCFUBENCMD_CMD_FIELD,
  SNOWREALMPARTYSYNCFUBENCMD_PARAM_FIELD,
  SNOWREALMPARTYSYNCFUBENCMD_STAGE_FIELD,
  SNOWREALMPARTYSYNCFUBENCMD_TRANSFORMED_USER_FIELD,
  SNOWREALMPARTYSYNCFUBENCMD_TOTAL_USER_FIELD,
  SNOWREALMPARTYSYNCFUBENCMD_KILLED_MONSTER_FIELD,
  SNOWREALMPARTYSYNCFUBENCMD_TOTAL_MONSTER_FIELD,
  SNOWREALMPARTYSYNCFUBENCMD_BOSS_GUID_FIELD,
  SNOWREALMPARTYSYNCFUBENCMD_END_TIME_FIELD,
  SNOWREALMPARTYSYNCFUBENCMD_IS_FINISH_FIELD
}
SNOWREALMPARTYSYNCFUBENCMD.is_extendable = false
SNOWREALMPARTYSYNCFUBENCMD.extensions = {}
SNOWREALMDAMAGERANKDATA_CHARID_FIELD.name = "charid"
SNOWREALMDAMAGERANKDATA_CHARID_FIELD.full_name = ".Cmd.SnowRealmDamageRankData.charid"
SNOWREALMDAMAGERANKDATA_CHARID_FIELD.number = 1
SNOWREALMDAMAGERANKDATA_CHARID_FIELD.index = 0
SNOWREALMDAMAGERANKDATA_CHARID_FIELD.label = 1
SNOWREALMDAMAGERANKDATA_CHARID_FIELD.has_default_value = false
SNOWREALMDAMAGERANKDATA_CHARID_FIELD.default_value = 0
SNOWREALMDAMAGERANKDATA_CHARID_FIELD.type = 4
SNOWREALMDAMAGERANKDATA_CHARID_FIELD.cpp_type = 4
SNOWREALMDAMAGERANKDATA_CHARNAME_FIELD.name = "charname"
SNOWREALMDAMAGERANKDATA_CHARNAME_FIELD.full_name = ".Cmd.SnowRealmDamageRankData.charname"
SNOWREALMDAMAGERANKDATA_CHARNAME_FIELD.number = 2
SNOWREALMDAMAGERANKDATA_CHARNAME_FIELD.index = 1
SNOWREALMDAMAGERANKDATA_CHARNAME_FIELD.label = 1
SNOWREALMDAMAGERANKDATA_CHARNAME_FIELD.has_default_value = false
SNOWREALMDAMAGERANKDATA_CHARNAME_FIELD.default_value = ""
SNOWREALMDAMAGERANKDATA_CHARNAME_FIELD.type = 9
SNOWREALMDAMAGERANKDATA_CHARNAME_FIELD.cpp_type = 9
SNOWREALMDAMAGERANKDATA_DAMAGE_FIELD.name = "damage"
SNOWREALMDAMAGERANKDATA_DAMAGE_FIELD.full_name = ".Cmd.SnowRealmDamageRankData.damage"
SNOWREALMDAMAGERANKDATA_DAMAGE_FIELD.number = 3
SNOWREALMDAMAGERANKDATA_DAMAGE_FIELD.index = 2
SNOWREALMDAMAGERANKDATA_DAMAGE_FIELD.label = 1
SNOWREALMDAMAGERANKDATA_DAMAGE_FIELD.has_default_value = false
SNOWREALMDAMAGERANKDATA_DAMAGE_FIELD.default_value = 0
SNOWREALMDAMAGERANKDATA_DAMAGE_FIELD.type = 4
SNOWREALMDAMAGERANKDATA_DAMAGE_FIELD.cpp_type = 4
SNOWREALMDAMAGERANKDATA.name = "SnowRealmDamageRankData"
SNOWREALMDAMAGERANKDATA.full_name = ".Cmd.SnowRealmDamageRankData"
SNOWREALMDAMAGERANKDATA.nested_types = {}
SNOWREALMDAMAGERANKDATA.enum_types = {}
SNOWREALMDAMAGERANKDATA.fields = {
  SNOWREALMDAMAGERANKDATA_CHARID_FIELD,
  SNOWREALMDAMAGERANKDATA_CHARNAME_FIELD,
  SNOWREALMDAMAGERANKDATA_DAMAGE_FIELD
}
SNOWREALMDAMAGERANKDATA.is_extendable = false
SNOWREALMDAMAGERANKDATA.extensions = {}
SNOWREALMDAMAGERANKSYNCFUBENCMD_CMD_FIELD.name = "cmd"
SNOWREALMDAMAGERANKSYNCFUBENCMD_CMD_FIELD.full_name = ".Cmd.SnowRealmDamageRankSyncFubenCmd.cmd"
SNOWREALMDAMAGERANKSYNCFUBENCMD_CMD_FIELD.number = 1
SNOWREALMDAMAGERANKSYNCFUBENCMD_CMD_FIELD.index = 0
SNOWREALMDAMAGERANKSYNCFUBENCMD_CMD_FIELD.label = 1
SNOWREALMDAMAGERANKSYNCFUBENCMD_CMD_FIELD.has_default_value = true
SNOWREALMDAMAGERANKSYNCFUBENCMD_CMD_FIELD.default_value = 11
SNOWREALMDAMAGERANKSYNCFUBENCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
SNOWREALMDAMAGERANKSYNCFUBENCMD_CMD_FIELD.type = 14
SNOWREALMDAMAGERANKSYNCFUBENCMD_CMD_FIELD.cpp_type = 8
SNOWREALMDAMAGERANKSYNCFUBENCMD_PARAM_FIELD.name = "param"
SNOWREALMDAMAGERANKSYNCFUBENCMD_PARAM_FIELD.full_name = ".Cmd.SnowRealmDamageRankSyncFubenCmd.param"
SNOWREALMDAMAGERANKSYNCFUBENCMD_PARAM_FIELD.number = 2
SNOWREALMDAMAGERANKSYNCFUBENCMD_PARAM_FIELD.index = 1
SNOWREALMDAMAGERANKSYNCFUBENCMD_PARAM_FIELD.label = 1
SNOWREALMDAMAGERANKSYNCFUBENCMD_PARAM_FIELD.has_default_value = true
SNOWREALMDAMAGERANKSYNCFUBENCMD_PARAM_FIELD.default_value = 193
SNOWREALMDAMAGERANKSYNCFUBENCMD_PARAM_FIELD.enum_type = FUBENPARAM
SNOWREALMDAMAGERANKSYNCFUBENCMD_PARAM_FIELD.type = 14
SNOWREALMDAMAGERANKSYNCFUBENCMD_PARAM_FIELD.cpp_type = 8
SNOWREALMDAMAGERANKSYNCFUBENCMD_DATAS_FIELD.name = "datas"
SNOWREALMDAMAGERANKSYNCFUBENCMD_DATAS_FIELD.full_name = ".Cmd.SnowRealmDamageRankSyncFubenCmd.datas"
SNOWREALMDAMAGERANKSYNCFUBENCMD_DATAS_FIELD.number = 3
SNOWREALMDAMAGERANKSYNCFUBENCMD_DATAS_FIELD.index = 2
SNOWREALMDAMAGERANKSYNCFUBENCMD_DATAS_FIELD.label = 3
SNOWREALMDAMAGERANKSYNCFUBENCMD_DATAS_FIELD.has_default_value = false
SNOWREALMDAMAGERANKSYNCFUBENCMD_DATAS_FIELD.default_value = {}
SNOWREALMDAMAGERANKSYNCFUBENCMD_DATAS_FIELD.message_type = SNOWREALMDAMAGERANKDATA
SNOWREALMDAMAGERANKSYNCFUBENCMD_DATAS_FIELD.type = 11
SNOWREALMDAMAGERANKSYNCFUBENCMD_DATAS_FIELD.cpp_type = 10
SNOWREALMDAMAGERANKSYNCFUBENCMD.name = "SnowRealmDamageRankSyncFubenCmd"
SNOWREALMDAMAGERANKSYNCFUBENCMD.full_name = ".Cmd.SnowRealmDamageRankSyncFubenCmd"
SNOWREALMDAMAGERANKSYNCFUBENCMD.nested_types = {}
SNOWREALMDAMAGERANKSYNCFUBENCMD.enum_types = {}
SNOWREALMDAMAGERANKSYNCFUBENCMD.fields = {
  SNOWREALMDAMAGERANKSYNCFUBENCMD_CMD_FIELD,
  SNOWREALMDAMAGERANKSYNCFUBENCMD_PARAM_FIELD,
  SNOWREALMDAMAGERANKSYNCFUBENCMD_DATAS_FIELD
}
SNOWREALMDAMAGERANKSYNCFUBENCMD.is_extendable = false
SNOWREALMDAMAGERANKSYNCFUBENCMD.extensions = {}
...
ESNOW_REALM_PARTY_STAGE_BOSS = 3
ESNOW_REALM_PARTY_STAGE_FAIL = 5
ESNOW_REALM_PARTY_STAGE_MIN = 0
ESNOW_REALM_PARTY_STAGE_MONSTER = 2
ESNOW_REALM_PARTY_STAGE_PREPARE = 1
ESNOW_REALM_PARTY_STAGE_SUCCESS = 4
ESTAT_TYPE_DAMAGE = 1
ESTAT_TYPE_MAX = 5
ESTAT_TYPE_MIN = 0
ESTAT_TYPE_RELIVE = 4
...
SKIL_ANIMATION = 141
SNOW_REALM_DAMAGE_RANK_SYNC = 193
SNOW_REALM_PARTY_SYNC = 192
...
SnowRealmDamageRankData = protobuf.Message(SNOWREALMDAMAGERANKDATA)
SnowRealmDamageRankSyncFubenCmd = protobuf.Message(SNOWREALMDAMAGERANKSYNCFUBENCMD)
SnowRealmPartySyncFubenCmd = protobuf.Message(SNOWREALMPARTYSYNCFUBENCMD)
