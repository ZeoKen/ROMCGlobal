ITEMPARAM = {
  ...
  ITEMPARAM_BALANCEMODE_MEMORY_SET = 167,
  ITEMPARAM_BALANCEMODE_MEMORY_UPDATE = 168,
  ITEMPARAM_MEMORY_EXCESS = 169,
  ITEMPARAM_FASHION_STAR_QUERY = 170,
  ITEMPARAM_FASHION_STAR_UP = 171,
  ITEMPARAM_QUICK_BUFF_PACKAGE = 172
}
EPACKTYPE = {
  EPACKTYPE_MIN = 0,
  EPACKTYPE_MAIN = 1,
...
EITEMTYPE = {
  ...
  EITEMTYPE_ARTIFACT_CONSUMABLE = 106,
  ...
  EITEMTYPE_SNOW_HEAD = 4301,
  EITEMTYPE_NOKR_DIAMOND = 4400,
  EITEMTYPE_NOKR_FREE_DIAMOND = 4401,
  EITEMTYPE_NOKR_MEDAL = 4402,
  EITEMTYPE_MAX = 4403
}
EEQUIPTYPE = {
  EEQUIPTYPE_MIN = 0,
...
EEXCHANGECARDTYPE = {
  ...
  EEXCHANGECARDTYPE_MVPCOMPOSE_RECALL = 7
}
ELOTTERYTYPE = {
  ELotteryType_Min = 0,
  ELotteryType_Head = 1,
...
EPACKMAILTYPE = {
  ...
  EPACKMAILTYPE_DESTROY_AIR_SHIP = 34,
  EPACKMAILTYPE_BAGE_LAB = 35,
  EPACKMAILTYPE_ICE_LAB = 36,
  EPACKMAILTYPE_LOTTERY_RAID = 37,
  EPACKMAILTYPE_MAX = 38
}
EPACKMAILSTATUS = {
