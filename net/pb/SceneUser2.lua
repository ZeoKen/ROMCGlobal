...
EOPTIONTYPE = {
  ...
  EOPTIONTYPE_LOTTERY_CNT_SPACETIME = 14,
  EOPTIONTYPE_MAX = 63
}
ERENAMEERRCODE = {
  ERENAME_SUCCESS = 0,
...
EEXTRACTIONCARDOPER = {
  EEXTRACTIONCARDOPER_MIN = 0,
  EEXTRACTIONCARDOPER_ON = 1,
  EEXTRACTIONCARDOPER_OFF = 2,
  EEXTRACTIONCARDOPER_MAX = 3
}
EEXTRACTUPDATETYPE = {
